...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ children, className, disabled, glossy = false, color = 'primary', size = 'md', full = false, ...props }, ref) => {
    ...
    const sizeConfig = {
      sm: { padding: 'px-[24px] py-[14px] lg:px-[32px] lg:py-[18px]', font: 'lg:text-[15px] text-[12px]' },
      md: { padding: 'px-[36px] h-[46px] lg:px-[50px] lg:h-[62px]', font: 'lg:text-[18px] text-[14px]' },
      lg: { padding: 'lg:px-[50px] px-[36px] lg:py-[20px] py-[15px]', font: 'lg:text-[18px] text-[14px]' }
    }
    ...
    return (
      <button
        ...
        className={cn(
          ...
          hoverActive,
          glossy
            ? 'before:z-[1] before:border-2 before:border-solid before:border-green after:z-0 after:bg-green after:blur-sm after:absolute after:inset-0 after:rounded-md after:transition after:duration-300'
            : '',
          disabled ? 'opacity-50' : ''
        )}
        {...props}
