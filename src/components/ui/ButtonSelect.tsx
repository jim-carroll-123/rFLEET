    ...
    <div className="flex lg:flex-row flex-col justify-between gap-[10px]">
      {options.map((option, index) => (
        <button
          ...
          className={cn(
            'relative flex items-center justify-center before:absolute before:inset-0 before:rounded-md before:transition before:duration-300 active:duration-75 h-[46px] lg:h-[62px] lg:px-[46px] px-[34px] max-w-[282px] hover:enabled:before:bg-primary hover:enabled:before:opacity-30 active:before:scale-[0.97] hover:after:blur-md active:after:blur-none active:after:bg-transparent',
